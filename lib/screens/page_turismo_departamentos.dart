...
class PageTurismoDepartamentos extends StatefulWidget {
  //
  PageTurismoDepartamentos() : super();

  final String title = 'RSS Feed Demo';

  @override
  PageTurismoDepartamentosState createState() =>
      PageTurismoDepartamentosState();
}

class PageTurismoDepartamentosState extends State<PageTurismoDepartamentos> {
  //
  // ignore: non_constant_identifier_names
  var FEED_URL = Uri.parse(
      'https://www.malargue.gov.ar/category/app/departamentos/feed/');
  RssFeed _feed;
  // ignore: unused_field
  String _title;
