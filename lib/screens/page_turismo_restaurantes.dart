...
class PageTurismoRestaurantes extends StatefulWidget {
  //
  PageTurismoRestaurantes() : super();

  final String title = 'RSS Feed Demo';

  @override
  PageTurismoRestaurantesState createState() =>
      PageTurismoRestaurantesState();
}

class PageTurismoRestaurantesState extends State<PageTurismoRestaurantes> {
  //
  // ignore: non_constant_identifier_names
  var FEED_URL = Uri.parse(
      'https://www.malargue.gov.ar/category/app/restaurantes/feed/');
  RssFeed _feed;
  // ignore: unused_field
  String _title;
