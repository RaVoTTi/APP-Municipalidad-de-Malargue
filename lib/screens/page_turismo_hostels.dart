...
class PageTurismoHostels extends StatefulWidget {
  //
  PageTurismoHostels() : super();

  final String title = 'RSS Feed Demo';

  @override
  PageTurismoHostelsState createState() =>
      PageTurismoHostelsState();
}

class PageTurismoHostelsState extends State<PageTurismoHostels> {
  //
  // ignore: non_constant_identifier_names
  var FEED_URL = Uri.parse(
      'https://www.malargue.gov.ar/category/app/hostels/feed/');
  RssFeed _feed;
  // ignore: unused_field
  String _title;
