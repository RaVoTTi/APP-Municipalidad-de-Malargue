...
class PageTurismoAlojamientoMolles extends StatefulWidget {
  //
  PageTurismoAlojamientoMolles() : super();

  final String title = 'RSS Feed Demo';

  @override
  PageTurismoAlojamientoMollesState createState() =>
      PageTurismoAlojamientoMollesState();
}

class PageTurismoAlojamientoMollesState extends State<PageTurismoAlojamientoMolles> {
  //
  // ignore: non_constant_identifier_names
  var FEED_URL = Uri.parse(
      'https://www.malargue.gov.ar/category/app/alojamiento-en-los-molles/feed/');
  RssFeed _feed;
  // ignore: unused_field
  String _title;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Alojamiento en Los Molles"),
        backgroundColor: Color(0xff00939d),
      ),
      body: body(),
    );
