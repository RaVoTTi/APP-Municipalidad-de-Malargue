...
class PageTurismoLugaresVisitar extends StatefulWidget {
  //
  PageTurismoLugaresVisitar() : super();

  final String title = 'RSS Feed Demo';

  @override
  PageTurismoLugaresVisitarState createState() =>
      PageTurismoLugaresVisitarState();
}

class PageTurismoLugaresVisitarState extends State<PageTurismoLugaresVisitar> {
  //
  // ignore: non_constant_identifier_names
  var FEED_URL = Uri.parse(
      'https://www.malargue.gov.ar/category/app/lugares-que-visitar/feed/');
  RssFeed _feed;
  // ignore: unused_field
  String _title;
